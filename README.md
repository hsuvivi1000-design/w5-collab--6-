...
**問題 1：在Pull Repquests時不太明白如何Approve組員的Request**

解決方式：在Submit當中實驗三個按鈕各自不同的功能，查看剩餘需Approve的人數是否減少

---

**問題 2：設定完應用在Branch上的Rule時，在每次更改README檔時，都需要他人Approve才能更改**

解決方式：確認完需要Merge的Requests都沒有問題後，並且也Merge完成，就暫時關閉Rule或減少至僅需1人Approve，直至.md檔都修改完成。
...
**林湘紜：**
在Pull Requests時的描述真的很重要，才能讓人迅速了解改動的地方，而且Review可以讓專案持有人及協作者在Merge前，先了解是否已達到可合併狀態，是遠端合作很重要的功能。
...
| 最終成果完整度      |      5        |   完美   |
**許瀞云：**
| PR 描述完整度       |      -      |   我負責marge PR   |
| Review comment 品質 |      4        |   每個分支都完成的很好，所以沒有特別有質量的Commet   |
| 回應 review 的態度  |       5       |   很好   |
| 最終成果完整度      |      5        |   很好   |
**林湘紜：**
| PR 描述完整度       |       4       |   應該還算清楚   |
| Review comment 品質 |      4        |   覺得都沒什麼大問題   |
| 回應 review 的態度  |       4       |   還可以?   |
| 最終成果完整度      |      5        |   整體來看很棒!   |
